...
```console
$ docker run --rm arm32v5/influxdb:2.0 influxd print-config > config.yml
```
...
```console
$ docker run -p 8086:8086 \
      arm32v5/influxdb:2.0 --storage-wal-fsync-delay=15m
```
