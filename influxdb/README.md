...
```console
$ docker run --rm riscv64/influxdb:2.0 influxd print-config > config.yml
```
...
```console
$ docker run -p 8086:8086 \
      riscv64/influxdb:2.0 --storage-wal-fsync-delay=15m
```
