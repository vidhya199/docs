...
-	[`1.6.18`, `1.6`, `1`, `latest`, `1.6.18-bullseye`, `1.6-bullseye`, `1-bullseye`, `bullseye`](https://github.com/docker-library/memcached/blob/32c314b7d14f704aa7596d748a3024043c6e9a7e/debian/Dockerfile)

[![mips64le/memcached build status badge](https://img.shields.io/jenkins/s/https/doi-janky.infosiftr.net/job/multiarch/job/mips64le/job/memcached.svg?label=mips64le/memcached%20%20build%20job)](https://doi-janky.infosiftr.net/job/multiarch/job/mips64le/job/memcached/)
...
```console
$ docker run --name my-memcache -d mips64le/memcached
```

## Setting Memory Usage

```console
$ docker run --name my-memcache -d mips64le/memcached memcached -m 64
```
